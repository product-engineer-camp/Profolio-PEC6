...
export const DeleteThemeListActionHeader = memo(
  ({ checkedThemeIds, hasCheckedThemes }: DeleteThemeListActionHeaderProps) => {
  ...
  (prev, next) => prev.hasCheckedThemes === next.hasCheckedThemes,
);

DeleteThemeListActionHeader.displayName = "DeleteThemeListActionHeader";
